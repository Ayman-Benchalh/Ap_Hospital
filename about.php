        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    <img class="img-fluid rounded w-100 align-self-end" src="img/img55.jpg" alt="">
                    <img class="img-fluid rounded w-75 bg-white pt-3 pe-3" src="img/img11.jpg" alt="" style="margin-top: -25%;">
                </div>
            </div>
