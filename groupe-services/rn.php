    ...
    <div class="container">
        <div class="row">
            ...
            <a class="nav-link link-dark py-3" href="rpd.php">
                ...
                <a class="nav-link link-light py-3 active bg-primary rounded" href="rn.php">
        ...
        <div class="col-md-8">
                <div class="content-header d-flex flex-column gap-3 py-4 px-3">
                    <img src="../assets/img/widget/rn_img.jpg" class="img-fluid service-image rounded " alt="Service Image">
