...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>Derrière Restaurant Soto Marina et Station Shell, Rue de Sebta، Tiflet 15400</small>
                </div>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    <img class="img-fluid rounded w-75 align-self-end" src="img/keni9.jpg" alt="">
                    <img class="img-fluid rounded w-50 bg-white pt-3 pe-3" src="img/keni7.jpg" alt="" style="margin-top: -25%;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
    ...
    <div class="container-xxl py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            ...
                            <h4 class="mb-3">
                            Rééducation Post-Opératoire</h4>
                            <p class="mb-4">
        Rééducation Post-Opératoire
        La thérapie manuelle orthopédique ou TMO, est un terme peu connu du grand public. Pourtant, cette discipline est pratiquée par des professionnels de santé depuis plusieurs décennies..</p>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            ...
                            <h4 class="mb-3">
                            Traitement Des Blessures Sportives</h4>
                            <p class="mb-4">
        Traitement Des Blessures Sportives
        Les blessures sportives sont fréquentes, et peuvent entraîner un arrêt prolongé de l’activité pratiquée. Claquage, entorse, luxation, fracture…</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Lire la suite</a>
                        </div>
                    </div>
        ...
        La thérapie manuelle orthopédique ou TMO, est un terme peu connu du grand public. Pourtant, cette discipline est pratiquée par des professionnels de santé depuis plusieurs décennies…</p>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            ...
                            <h4 class="mb-3">
                            Rééducation Neurologique</h4>
                            <p class="mb-4">
        Rééducation Neurologique
        La kinésithérapie neurologique se réfère à l’utilisation de cette thérapie pour évaluer et soigner les problèmes liés au système nerveux: les pathologies et les troubles neurologiques…</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Lire la suite</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item bg-light rounded h-100 p-5">
                            ...
                            <h4 class="mb-3">
                            Rééducation Respiratoire </h4>
                            <p class="mb-4">
        Rééducation Respiratoire
        La kinésithérapie respiratoire désigne un ensemble de techniques visant à désobstruer le nez et désencombrer les bronches. En pratique, il s’agit de manœuvres externes,…</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Lire la suite</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
        ...
        On définit une douleur chronique comme étant une douleur persistante au delà de ce qui est habituel pour la pathologie en cause….</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Lire la suite</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-0 mx-lg-0">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="position-absolute img-fluid w-100 h-100" src="img/keni3.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
