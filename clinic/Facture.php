...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT doctor_id FROM doctors WHERE clinic_id = $clinic_id LIMIT 1";
    $result = mysqli_query($conn, $query);
    ...
    if ($result && mysqli_num_rows($result) > 0) {
            ...
            // You can now use $doctor_id for further logic
            
        } else {
            // Handle the case where no result was found or the query failed
            echo "No doctor found or query failed: " . mysqli_error($conn);
    }
