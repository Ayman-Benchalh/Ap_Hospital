    ...
    <div class="page-content" id="content">
        ...
        <div class="row">
            <!-- <div class="col-12 mt-3 mb-3">
                <a href="./doctor-edit.php" class="btn btn-primary btn-sm pull-right px-5">Modifier le profil du médecin</a>
            </div> -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if ($doctor_row["doctor_avatar"] != "") {
                            echo '<img src="../uploads/' . $doctor_row["clinic_id"] . '/doctor' . '/' . $doctor_row["doctor_avatar"] . '" id="output" class="img-fluid thumbnail" alt="Avatar du Médecin" title="Avatar du Médecin">';
                        } else {
                            echo '<img src="./img/empty-avatar.jpg" id="output" class="img-fluid thumbnail" alt="Avatar du Médecin" title="Avatar du Médecin">';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-md-9">
                ...
                <div class="mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p><i class="fas fa-vote-yea fa-fw mr-3"></i><?= $doctor_row["doctor_experience"]; ?> Ans d'expérience</p>
