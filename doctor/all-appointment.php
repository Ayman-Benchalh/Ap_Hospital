...
// S'assurer que $clinic_row et $conn sont correctement initialisés dans session.inc.php
...
// Récupérer la page actuelle à partir de l'URL, par défaut 1 si non définie
            ...
            if ($clinic_id > 0) {
                ...
                if ($stmt) {
                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        echo '<th>Patient</th>';
                        echo '<th>Contact du Patient</th>';
                        echo '<th>Médecin</th>';
                        echo '<th>Ext Médecin</th>';
                        echo '<th>Statut</th>';
