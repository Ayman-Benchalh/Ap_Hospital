    ...
    <div class="page-content" id="content">
        ...
        <div class="row">
            <div class="col-12 mt-3 mb-3">
                <a href="./doctor-edit.php" class="btn btn-primary btn-sm pull-right px-5">Modifier le profil</a>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if ($doctor_row["doctor_avatar"] != "") {
                            ...
                            echo '<img src="./img/empty-avatar.jpg" id="output" class="img-fluid thumbnail" alt="Avatar-Docteur" title="Avatar-Docteur">';
                        }
                        ?>
                    </div>
                </div>
